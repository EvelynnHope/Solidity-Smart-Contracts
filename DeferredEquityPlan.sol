...
contract DeferredEquityPlan {
   // uint fakenow = now;
    ...
    uint unlock_time = now + 365;    //  Set the `unlock_time` to be 365 days from now
   ...
   fakenow += 365 days;
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "Transactions not permitted");
        require(distributed_shares < total_shares, "Distributed share must be lesser than Total shares");
